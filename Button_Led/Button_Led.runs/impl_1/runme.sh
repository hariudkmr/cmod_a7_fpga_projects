...
HD_PWD='C:/Work/FPGA_WS/Button_Led/Button_Led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source btn_led.tcl -notrace
