...
HD_PWD='C:/Work/FPGA_WS/Button_Led/Button_Led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log btn_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source btn_led.tcl
