...
// i2c_module module
//
// Intended target for CMOD-A7 15T 
//
// Author:  Xilinx, Inc.
//
...
module i2c_module (
   ...
   input [1:0]  gpio_input_pins; // gp io from pins to I2C bus
   ...
   output [1:0] gpio_output_pins;// gp io from I2C to pins
...
//			sda_out <= gpio_input[1-index];
   ...
   wire [1:0] gpio_output_pins = gpio_output;
